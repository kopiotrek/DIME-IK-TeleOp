...
from ik_teleop.teleop_utils.hand_detector import HandJointStatePublisher
...
def detector():
    mp_detector = HandJointStatePublisher()
    # mp_detector.run()
...
def robot_controller():
    control = AllegroHandOperator("/home/vm/rpl/Open-Teach/configs/robot/allegro_sim.yaml")
    control.move()
